...
-- Adding Comparison Logic between Actual and Project Data

--Create reach_goal_flag and decode actual and planning status in order to create a progress logic
,comparison_logic AS (
  SELECT
        Sprint,
        Spoke,
        ...
        Sprint_Status,
        CASE 
            WHEN Actual_Status = Planning_Status THEN 'Yes'
            ELSE 'No' 
        END AS reach_goal_flg,
        CASE 
